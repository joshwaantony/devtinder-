...
//         <h1 className="text-white text-3xl font-extrabold mb-2 text-center">Complete Your Profile</h1>
//         <p className="text-white/70 text-center mb-8">Add details to make your profile stand out</p>

//         {/* Profile Photo */}
//         <div className="mb-6">
//           <label className="block text-white font-semibold mb-2 flex items-center gap-2"><FaUser /> Profile Photo</label>
//           <input
//             type="file"
//             accept="image/*"
//             onChange={(e) => setShowPhotoPreview(URL.createObjectURL(e.target.files[0]))}
...
//           />
//           {showPhotoPreview && (
//             <img src={showPhotoPreview} alt="Preview" className="mt-4 w-24 h-24 rounded-full object-cover border-2 border-white/20" />
//           )}
//           <p className="text-white/50 text-sm mt-1">Drag & drop or click to browse. PNG, JPG, GIF up to 100MB.</p>
//         </div>

//         {/* Gender & Age */}
//         <div className="grid grid-cols-2 gap-4 mb-6">
//           <div>
//             <label className="block text-white font-semibold mb-2 flex items-center gap-2"><FaUser /> Gender</label>
//             <select
//               value={gender}
...
//           </div>
//           <div>
//             <label className="block text-white font-semibold mb-2 flex items-center gap-2"><FaUser /> Age</label>
//             <input
//               type="number"
//               value={25}
//               readOnly
...
//         {/* Location & Headline */}
//         <div className="mb-6">
//           <label className="block text-white font-semibold mb-2 flex items-center gap-2"><FaMapMarkerAlt /> Location</label>
//           <input
//             type="text"
...
//         </div>
//         <div className="mb-6">
//           <label className="block text-white font-semibold mb-2 flex items-center gap-2"><FaBriefcase /> Headline</label>
//           <input
//             type="text"
...
//         <div className="grid grid-cols-2 gap-4 mb-6">
//           <div>
//             <label className="block text-white font-semibold mb-2 flex items-center gap-2"><FaPhone /> Phone Number</label>
//             <input
//               type="text"
...
//           </div>
//           <div>
//             <label className="block text-white font-semibold mb-2 flex items-center gap-2"><FaGraduationCap /> Experience Level</label>
//             <select
//               value={experience}
...
//         {/* Skills */}
//         <div className="mb-6">
//           <label className="block text-white font-semibold mb-2 flex items-center gap-2"><FaHashtag /> Skills & Technologies</label>
...
//               <span key={idx} className="px-3 py-1 rounded-full bg-white/20 text-white text-sm flex items-center gap-1">
//                 {skill} <FaTimes className="cursor-pointer" onClick={() => removeSkill(skill)} />
//               </span>
//             ))}
//           </div>
//           <p className="text-white/50 text-sm mt-2">
//             Popular skills: JavaScript, TypeScript, Python, Java, Go, Rust, React, Angular, Vue.js, Next.js, Node.js, Express, Django, Flask, Spring Boot, PostgreSQL, MongoDB, Redis, Docker, Kubernetes
//           </p>
//         </div>

//         {/* Bio */}
//         <div className="mb-6">
//           <label className="block text-white font-semibold mb-2 flex items-center gap-2"><FaInfoCircle /> Bio</label>
//           <textarea
...
//             <input type="text" placeholder="GitHub: https://github.com/username" className="flex-1 py-3 px-4 rounded-xl bg-white/20 text-white border border-white/20 focus:outline-none focus:ring-2 focus:ring-cyan-400 transition" />
//           </div>
//           <div className="flex gap-2">
//             <FaLinkedin className="text-white/70 mt-3" />
//             <input type="text" placeholder="LinkedIn: https://linkedin.com/in/username" className="flex-1 py-3 px-4 rounded-xl bg-white/20 text-white border border-white/20 focus:outline-none focus:ring-2 focus:ring-cyan-400 transition" />
//           </div>
//           <div className="flex gap-2">
//             <FaGlobe className="text-white/70 mt-3" />
//             <input type="text" placeholder="Portfolio: https://yourportfolio.com" className="flex-1 py-3 px-4 rounded-xl bg-white/20 text-white border border-white/20 focus:outline-none focus:ring-2 focus:ring-cyan-400 transition" />
//           </div>
//           <div className="flex gap-2">
//             <FaTwitter className="text-white/70 mt-3" />
//             <input type="text" placeholder="Twitter: https://twitter.com/username" className="flex-1 py-3 px-4 rounded-xl bg-white/20 text-white border border-white/20 focus:outline-none focus:ring-2 focus:ring-cyan-400 transition" />
//           </div>
//         </div>
...
//           <a href="#" className="text-[#40CFFA] font-semibold hover:underline">Sign in</a>
//         </p>
