...
//     <div className="min-h-screen bg-[#161E30] flex items-center justify-center px-4">
//       <div className="max-w-md w-full bg-[#212940]/90 rounded-2xl p-8 shadow-2xl backdrop-blur-md border border-white/10">
//         <h1 className="text-white text-3xl font-bold mb-1 text-center">Sign Up</h1>
//         <p className="text-[#A1B4CC] mb-6 text-center text-base">Create your account</p>

//         {/* Social Buttons */}
//         <div className="flex space-x-3 mb-6">
//           <button className="flex-1 flex justify-center items-center gap-2 rounded-lg bg-[#232A38] text-[#D1DAE8] py-2.5 font-semibold border border-[#232A38] hover:bg-[#323C53] transition">
//             <svg
//               className="w-5 h-5"
//               fill="currentColor"
//               viewBox="0 0 24 24"
...
//               fill="none"
//             >
//               <path fill="#4285F4" d="M21.35 11.1H12v2.76h5.42c-.23 1.28-.89 2.36-1.87 3.1v2.56h3.02c1.86-1.73 2.95-4.28 2.95-7.36z" />
//               <path fill="#34A853" d="M12 22c2.7 0 4.96-.89 6.61-2.43l-3.23-2.37c-.89.6-2.02.97-3.38.97-2.6 0-4.81-1.76-5.6-4.13H1.05v2.41A10 10 0 0 0 12 22z" />
//               <path fill="#FBBC05" d="M4.4 12.04A5.99 5.99 0 0 1 3.67 9.98v-2.41H1.05A10.01 10.01 0 0 0 0 10c0 1.56.37 3.04 1.05 4.31l3.35-2.27z" />
//               <path fill="#EA4335" d="M10 4c1.48 0 2.81.51 3.85 1.5l2.88-2.88A9.96 9.96 0 0 0 10 0C6.13 0 2.76 2.29 1.05 5.69l3.35 2.41C5.19 6.56 7.43 4.8 10 4z" />
//             </svg>
//             Google
//           </button>
//         </div>
...
//           <hr className="flex-grow border-[#2B3951]" />
//           <span className="mx-4 text-[#A1B4CC] text-sm">or</span>
//           <hr className="flex-grow border-[#2B3951]" />
//         </div>
...
//           <div>
//             <label className="block text-[#D1DAE8] font-semibold mb-1 text-sm">First Name</label>
//             <input
//               type="text"
//               placeholder="sebastian"
//               className="w-full py-3 px-4 bg-[#232A39]/70 rounded-lg text-[#ABB8D0] placeholder-[#636E8F] focus:outline-none border border-transparent focus:border-[#3B58DD] transition"
//             />
//           </div>
//           <div>
//             <label className="block text-[#D1DAE8] font-semibold mb-1 text-sm">Last Name</label>
//             <input
//               type="text"
//               placeholder="andrews"
//               className="w-full py-3 px-4 bg-[#232A39]/70 rounded-lg text-[#ABB8D0] placeholder-[#636E8F] focus:outline-none border border-transparent focus:border-[#3B58DD] transition"
...
//         {/* Username */}
//         <div className="mb-4">
//           <label className="block text-[#D1DAE8] font-semibold mb-1 text-sm">Username</label>
//           <input
//             type="text"
//             placeholder="sebastianseban"
//             className="w-full py-3 px-4 bg-[#232A39]/70 rounded-lg text-[#ABB8D0] placeholder-[#636E8F] focus:outline-none border border-transparent focus:border-[#3B58DD] transition"
//           />
//           <p className="text-xs text-[#60739B] mt-1">3-30 chars, letters & numbers only</p>
//         </div>

//         {/* Email */}
//         <div className="mb-4">
//           <label className="block text-[#D1DAE8] font-semibold mb-1 text-sm">Email</label>
//           <input
//             type="email"
...
//         <div className="grid grid-cols-2 gap-4 mb-6">
//           <div>
//             <label className="block text-[#D1DAE8] font-semibold mb-1 text-sm">Password</label>
...
//                 className="absolute right-3 top-3 text-[#60739B] hover:text-[#8AA9F9]"
...
//           <div>
//             <label className="block text-[#D1DAE8] font-semibold mb-1 text-sm">Confirm</label>
//             <div className="relative">
//               <input
...
//         {/* Submit Button */}
//         <button className="w-full py-3 rounded-lg font-bold text-white bg-gradient-to-r from-[#40CFFA] to-pink-400 hover:opacity-90 transition shadow-lg">
//           Continue
//         </button>

//         {/* Footer */}
//         <p className="mt-5 text-center text-[#A1B4CC] text-sm">
